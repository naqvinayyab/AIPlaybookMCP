...
describe('MarkdownConverter', () => {
  it('should preserve heading hierarchy (h2 -> ##, h3 -> ###)', async () => {
    const _html = '<h2>Heading 2</h2><h3>Heading 3</h3><h4>Heading 4</h4>';
    const _expectedMarkdown = '## Heading 2\n\n### Heading 3\n\n#### Heading 4';
  ...
  it('should convert tables to GFM format', async () => {
    ...
    const _expectedContains = '| Header 1 | Header 2 |';
  ...
  it('should handle blockquotes', async () => {
    const _html = '<blockquote><p>Quoted text</p></blockquote>';
    const _expected = '> Quoted text';
  ...
  it('should remove govspeak classes and IDs', async () => {
    const _html = '<div class="govspeak"><p id="para-1" class="govuk-body">Text</p></div>';

    // Resulting markdown should not contain class or id attributes
    const _shouldNotContain = ['govspeak', 'govuk-body', 'para-1'];
  ...
  it('should preserve emphasis (bold, italic)', async () => {
    const _html = '<p><strong>Bold</strong> and <em>italic</em></p>';
    const _expected = '**Bold** and _italic_';
  ...
  it('should preserve links', async () => {
    const _html = '<p><a href="https://example.com">Link text</a></p>';
    const _expected = '[Link text](https://example.com)';
  ...
  it('should handle code blocks', async () => {
    const _html = '<pre><code>const x = 1;</code></pre>';
    const _expected = '```\nconst x = 1;\n```';
